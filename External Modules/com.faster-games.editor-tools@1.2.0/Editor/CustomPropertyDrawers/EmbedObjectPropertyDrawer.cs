...
{
    /// <summary>
    /// Property drawer for <see cref="EmbedObjectAttribute"/> tagged objects
    /// </summary>
    /// <remarks>
    /// Allows devs to embed scriptable object property editors inside one-another.
    /// This is based on https://gist.github.com/tomkail/ba4136e6aa990f4dc94e0d39ec6a058c
    /// </remarks>
    [CustomPropertyDrawer(typeof(EmbedObjectAttribute))]
    public class EmbedObjectPropertyDrawer : PropertyDrawer
    {
        /// <inheritdoc />
        ...
        /// <summary>
        /// Checks if an sub property is visible except m_Script
        /// </summary>
