...
namespace CairoEngine
{
    ...
    public class InventoryModule
    {
        ...
        /// </summary>
        private static List<InventoryItemTemplate> itemInfos = new List<InventoryItemTemplate>();
        ...
        private static InventoryItemTemplate GetItemInfo(string ID)
        {
            foreach (InventoryItemTemplate itemInfo in itemInfos)
            {
                if (itemInfo.ID == ID)
                {
                    return itemInfo;
