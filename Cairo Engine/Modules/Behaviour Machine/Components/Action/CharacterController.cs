...
namespace CairoEngine.Behaviour
{
    ...
    public class CharacterController : CairoBehaviour<BehaviourTemplate_CharacterController>
    {
        ...
        {
            SetProperty("characterControllerComponent", gameObject.transform.Find(template.controllerPath).gameObject.GetComponent<UnityEngine.CharacterController>());
            //Get a local reference
            characterController = (UnityEngine.CharacterController)root.properties["characterControllerComponent"];
