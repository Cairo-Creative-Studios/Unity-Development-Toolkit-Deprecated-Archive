...
namespace CairoEngine
{
    ...
    public class DamageInstegator
    {
        ...
        public DamageInstegator(DamageTypeInfo damageType, Vector3 damageSource, object owningEntity = null, int team = -1)
        {
            info = damageType;
        ...
        private void Instegate()
        {
            ...
            Collider[] hitColliders = Physics.OverlapSphere(damageSource, info.radius);
